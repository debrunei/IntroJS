...
Names: Neil DeBruhl  Nery  (______________________)
...
let msgRules = "Here are the rules...";
let msgKind = "Be kind.";
...
// TODO comment: Makes a city name
let city = "Indianapolis";

// TODO comment: Prints city name
...
// 7a) let 2cool = "nope";        // YES / NO: no
// 7b) let my_name = "ok";        // YES / NO: yes
// 7c) let class = "reserved";    // YES / NO: no
// 7d) let firstName = "ok";      // YES / NO: yes
// 7e) let $total = 10;           // YES / NO: yes
